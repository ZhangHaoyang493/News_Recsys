...
def parse_args():
    parser = argparse.ArgumentParser(description="LR Training")
    parser.add_argument("--config", "-c", type=str, default="/data2/zhy/Movie_Recsys/src/model/sort/lr/train_cf_lr.yaml", help="Path to config file")
