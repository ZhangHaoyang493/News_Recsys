...
def parse_args():
    ...
    parser.add_argument("--config", "-c", type=str, default="/data2/zhy/Movie_Recsys/src/model/sort/dcn/train_cf_dcn.yaml", help="Path to config file")
