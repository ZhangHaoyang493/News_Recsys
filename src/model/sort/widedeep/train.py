...
def parse_args():
    parser = argparse.ArgumentParser(description="WideDeep Training")
    parser.add_argument("--config", "-c", type=str, default="/data2/zhy/Movie_Recsys/src/model/sort/deep/train_cf_widedeep.yaml", help="Path to config file")
